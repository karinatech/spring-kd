...
public class DataGenerator implements CommandLineRunner {
     ...
     * Movie Objects.
     */
    public Movie m1 = new Movie("The Gentleman", LocalDate.of(2020, 1, 24), 113, Type.REGULAR, Statee.ACTIVE, new BigDecimal("20.00"));
    public Movie m2 = new Movie("A Beautiful Mind", LocalDate.of(2002, 1, 04), 135, Type.REGULAR, Statee.DRAFT, new BigDecimal("15.00"));
    public Movie m3 = new Movie("The Shawshank Redemption", LocalDate.of(1994, 10, 14), 142, Type.REGULAR, Statee.DRAFT, new BigDecimal("35.00"));
    public Movie m4 = new Movie("The Godfather", LocalDate.of(1972, 3, 24), 175, Type.REGULAR, Statee.DRAFT, new BigDecimal("35.00"));
    public Movie m5 = new Movie("Tenet", LocalDate.of(2020, 9, 3), 150, Type.PREMIER, Statee.ACTIVE, new BigDecimal("35.00"));
    public Movie m6 = new Movie("The Loss Adjuster", LocalDate.of(2020, 12, 29), 100, Type.PREMIER, Statee.DRAFT, new BigDecimal("35.00"));
    public Movie m7 = new Movie("The Nights Before Christmas", LocalDate.of(2020, 11, 19), 100, Type.REGULAR, Statee.ACTIVE, new BigDecimal("28.00"));
    public Movie m8 = new Movie("Spider-Man: Miles Morales", LocalDate.of(2020, 12, 12), 130, Type.REGULAR, Statee.DRAFT, new BigDecimal("28.00"));
    public Movie m9 = new Movie("Avengers: Endgame", LocalDate.of(2019, 4, 26), 181, Type.REGULAR, Statee.DRAFT, new BigDecimal("48.00"));
    ...
    Account a1 = new Account("Josie D Story", "262  Lochmere Lane", "United States", "Kentucky", "LOUISVILLE", 35, "40289", Role.USER);
    Account a2 = new Account("Bernard P Fendley", "2903  Jarvis Street", "United States", "New York", "Buffalo", 28, "14211", Role.USER);
    Account a3 = new Account("Faith R Parsons", "4161  Alfred Drive", "United States", "New York", "Brooklyn", 47, "11226", Role.USER);
    Account a4 = new Account("Johnnie J Cannon", "2587  Logan Lane", "United States", "New York", "HOLTSVILLE", 47, "00544", Role.USER);
    Account a5 = new Account("Lawrence E Folkerts", "698  Clark Street", "United States", "New York", "Brentwood", 47, "11717", Role.USER);
    ...
    //public Location(String name, BigDecimal latitude, BigDecimal longitude, String postalCode, String country, String city,String address)
